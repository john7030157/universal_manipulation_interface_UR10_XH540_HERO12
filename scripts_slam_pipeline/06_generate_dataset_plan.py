...
@click.option('-to', '--tcp_offset', type=float, default=0.284, help="Distance from gripper tip to mounting screw")
    ...
    for demo_idx, demo_data in enumerate(demo_data_list):
        ...
        for cam_idx, row in demo_video_meta_df.iterrows():
            ...
            if outlier_filter:
                ...
                # where large velocity spikes are part of the task, not SLAM glitches.
